...
// Filename: Ziaad video.ggsk
// Generated 2024-08-09T13:06:43
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		elHorScrollBg.setAttribute('style', 'position: absolute; left: 0px; bottom: 0px; visibility: hidden; width: 768px; height: 15px; background-color: rgba(0,0,0,0.392157); pointer-events: auto;');
		elHorScrollBg.className='ggskin ggskin_scrollarea_hscrollbg';
		elHorScrollFg = me._thumbnail_menu__horScrollFg = document.createElement('div');
		elHorScrollBg.appendChild(elHorScrollFg);
		elHorScrollFg.className='ggskin ggskin_scrollarea_hscrollfg';
		elHorScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 768px; height: 15px; background-color: rgba(0,0,0,1); pointer-events: auto;');
		...
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 360px; background-color: rgba(0,0,0,0.392157); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._thumbnail_menu_mobile__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 360px; background-color: rgba(0,0,0,1); pointer-events: auto;');
		...
		me._text_1.onclick=function (e) {
				player.playPauseSound("_videopanorama","1");
		}
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		els.innerHTML="Appuyez sur l\'\xe9cran pour lancer la vid\xe9o.";
		el.appendChild(els);
	...
	function SkinHotspotClass_node(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		el=me._node=document.createElement('div');
		el.ggId="node";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		...
		me._node.onclick=function (e) {
			player.openNext(me.hotspot.url,"");
			skin.hotspotProxyClick(me.hotspot.id, me.hotspot.url);
		}
		me._node.ondblclick=function (e) {
			skin.hotspotProxyDoubleClick(me.hotspot.id, me.hotspot.url);
		}
		me._node.onmouseover=function (e) {
			player.setActiveHotspot(me.hotspot);
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		me._node.onmouseout=function (e) {
			player.setActiveHotspot(null);
			skin.hotspotProxyOut(me.hotspot.id, me.hotspot.url);
		}
		me._node.ggUpdatePosition=function (useTransition) {
		}
		el=me._marker_active=document.createElement('div');
		els=me._marker_active__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'IDxjaXJjbGUgc3Ryb2tlLW1pdGVybGltaXQ9IjEwIiByPSIyLjExNyIgc3Ryb2tlPSIjZWUxZDNhIiBjeD0iMTQuOTgiIGZpbGw9IiMwMDAwMDAiIHN0cm9rZS13aWR0aD0iMC41IiBzdHJva2Utb3BhY2l0eT0iMCIgY3k9IjMuOTk0IiBmaWxsLW9wYWNpdHk9IjEiLz4KIDwvZz4KPC9zdmc+Cg==';
		...
		me._node.appendChild(me._marker_active);
	...
	me.addSkinHotspot=function(hotspot) {
		...
		{
			hotspot.skinid = 'node';
			hsinst = new SkinHotspotClass_node(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
	...
	me.removeSkinHotspots=function() {
		...
		if(hotspotTemplates['node']) {
			var i;
			for(i = 0; i < hotspotTemplates['node'].length; i++) {
				hotspotTemplates['node'][i] = null;
			}
		}
		hotspotTemplates = [];
	}
